...
class LoginState extends Equatable {
  ...
  LoginState copyWith({
    ...
    return LoginState(
      ...
      isAuthen: isAuthen ?? this.isAuthen,
    ); //ถ้าไม่มีค่า count ส่งมา ให้ใช้ ค่าเก่า (this.count)
  }
  ...
  List<Object?> get props => [
        count,
        isAuthen,
      ]; //members ต้อง เป็น ตัวแปร ที่ เปลี่ยนแล้ว UI Update
}
